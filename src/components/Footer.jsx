...
const Footer = () => {
  return (
    <div className='bg-[black] text-[white] h-[480px] w-full'>
      <div className='grid grid-cols-2 md:grid-cols-4  py-10 pl-6 '>
        <div>
            <h2 className='font-semibold mb-3  text-[18px] md:text-[22px]'>B<span className='text-[#FAA300]'>G</span></h2>
        ...
        <div>
            ...
            <p className='text-[gray] text-[13px] md:text-[16px] mb-2'>Bg One</p>
            <p className='text-[gray] text-[13px] md:text-[16px] mb-2'>Bg instamart</p>
            <p className='text-[gray] text-[13px] md:text-[16px] mb-2'>Bg Gein</p>
        </div>

        <div>
            <h2 className='font-semibold mb-3  text-[18px] md:text-[22px] text-[#FAA300]'>BG</h2>
        ...
        <div>
            <h2 className='font-semibold mb-3  text-[18px] md:text-[22px] text-[#FAA300]'>BG Branches:</h2>
